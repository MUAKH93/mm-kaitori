...
function mma_content_admin_page() {
	...
	<div class="wrap">
		...
		<p>プログラマー不要でホームページの文章を変更できます。変更後は必ず「保存」を押してください。
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=mma-editor-guide' ) ); ?>">How to edit (EN) →</a>
			|
			<a href="<?php echo esc_url( admin_url( 'customize.php?autofocus[section]=mma_homepage_banners' ) ); ?>">Change homepage pictures →</a>
		</p>
